...
var fetchedRepo = [Repositorio]()
    ...
    func parseData(){
        ...
        let url = "https://api.github.com/search/repositories?q=language:swift&sort=stars&page=3"
            ...
            do {
                ...
                if let fetchedData = fetchedData as? Dictionary<String, AnyObject>, let repo = fetchedData["items"] as? [Any] {
                    ...
                    for eachFetchedRepositorio in repo {
                            ...
                            //pegando o owner
                        if let eachFetchedRepositorio = eachFetchedRepositorio as? AnyObject, let owner =
                            eachFetchedRepositorio["owner"] as? NSDictionary {
...
//MARK: - Transformar a string em imagem
